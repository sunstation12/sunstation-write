...
<h2 class="account_title">Tài khoản đã Cấp quyền</h2>
...
<?php
$count_account = "../../server/file_licensing/licensed/";
$filecount = 0;
...
foreach (new DirectoryIterator('../../server/file_licensing/licensed/') as $fileInfo)
{
